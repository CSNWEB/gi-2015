...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FormView_t, stringdata) + ofs \
...
const QMetaObject FormView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_FormView.data,
...
void *FormView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormView.stringdata))
